...
<body class="h-full">
    ...
    <nav class="navbar fixed top-0 z-50 w-full h-14 flex items-center px-4">
        <button id="toggleSidebar" class="p-2" aria-label="Toggle sidebar">
            <svg class="w-6 h-6 text-gray-700 transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="flex items-center ml-4">
            ...
            <span class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 text-xl">Vistana</span>
        ...
        <div class="ml-auto flex items-center space-x-4">
            ...
            <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
                ...
                type="button">
                <svg class="w-6 h-6 text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" onclick="event.preventDefault();
                                                    this.closest('form').submit();" class="flex items-center gap-3 py-3 text-red-600 hover:text-red-700">
    ...
    <div id="dropdownNotification"
        class="dropdown-content z-50 hidden w-full max-w-sm absolute right-4 top-14 mt-2"
        aria-labelledby="dropdownNotificationButton">
        <div class="block px-4 py-3 font-semibold text-gray-800 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                    ...
                    <a href="{{ route('readnotification',$notification) }}" 
                       class="flex px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors duration-200">
                        ...
                        <div class="w-full ps-3">
                            ...
                            <div class="text-xs text-blue-500 font-medium">{{ $notification->created_at->diffForHumans() }}</div>
                        </div>
                    </a>
                @endforeach
            @else
                ...
                <li>
                    <a href="{{ route('users.index') }}" 
                       class="flex items-center gap-3 p-3 {{ Route::currentRouteName() == 'users.index' || str_starts_with(Route::currentRouteName(), 'users.') ? 'active' : '' }}">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-1a4 4 0 00-5-3.87M9 20H4v-1a4 4 0 015-3.87m6-7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('rooms.index') }}" 
                       class="flex items-center gap-3 p-3 {{ Route::currentRouteName() == 'rooms.index' || str_starts_with(Route::currentRouteName(), 'rooms.') ? 'active' : '' }}">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 21V7a2 2 0 012-2h14a2 2 0 012 2v14M3 10h18" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('ratings.index') }}" 
                       class="flex items-center gap-3 p-3 {{ Route::currentRouteName() == 'ratings.index' || str_starts_with(Route::currentRouteName(), 'ratings.') ? 'active' : '' }}">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l2.01 6.18h6.49l-5.25 3.81 2.01 6.18L12 15.27l-5.21 3.83 2.01-6.18-5.25-3.81h6.49z" />
                        </svg>
