...
<div class="py-6">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Edit Service: {{ $service->name }}</h2>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-8">
                ...
                @can('edit services')
                    <form action="{{ route('serv.update', ['service' => $service->id]) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description', $service->description) }}</textarea>
                        </div>
