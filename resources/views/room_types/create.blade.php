                ...
                <div class="p-8">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                                        @foreach ($services as $service)
                                            <label class="inline-flex items-center group cursor-pointer">
                                                ...
                                                <span
                                                    class="ml-2 text-sm text-gray-700 group-hover:text-indigo-700 font-medium transition">{{ $service->name }}</span>
                                            </label>
                                        @endforeach
                                    </div>
                                    @if ($services->isEmpty())
                                        <p class="text-sm text-gray-500 italic text-center">No services found. <a
                                                href="{{ route('serv.create') }}" class="text-indigo-600 hover:underline">Add
                                                services first</a>.</p>
                                    @endif
                                </div>
                            </div>
                    ...
                    @else
                        <p class="text-red-500 text-sm">
                            You are not authorized to create room types.
                        </p>
                    @endcan
                </div>
            </div>
