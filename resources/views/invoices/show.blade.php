        ...
        <div class=" mx-auto">
            ...
            <div class="flex justify-between items-center mb-6 print:hidden">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('invoices.pdf', $invoice->id) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg">
                        Download PDF
                    </a>
            ...
            {{-- Invoice Paper --}}
            <div
                class="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden print:shadow-none print:border-none">
                <div class="p-10">
                    ...
                    <div class="flex justify-between items-start border-b border-gray-100 pb-8 mb-8">
                        <div>
                            ...
                            <div
                                class="mt-4 inline-block px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm text-gray-500 mt-1">123 Luxury Street<br>Damascus, Syria<br>info@vistana.com
                            </p>
                    ...
                    <div class="grid grid-cols-2 gap-8 mb-8">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-gray-800"><span class="font-medium">Method:</span>
                                {{ ucfirst($invoice->payment_method) }}</p>
                            <p class="text-gray-800"><span class="font-medium">Reservation ID:</span>
                                #{{ $invoice->reservation->id }}</p>
                        </div>
                    </div>
                        ...
                        <tbody class="text-gray-700">
                            <tr>
                                <td class="py-4 px-4 border-b border-gray-100">
                                    <span class="font-bold block">Room Stay (Room
                                        {{ $invoice->reservation->room->room_number }})</span>
                                    <span class="text-xs text-gray-500">Check-in: {{ $invoice->reservation->start_date }} /
                                        Out: {{ $invoice->reservation->end_date }}</span>
                                </td>
                                <td class="text-center py-4 px-4 border-b border-gray-100">
                                    {{ \Carbon\Carbon::parse($invoice->reservation->start_date)->diffInDays($invoice->reservation->end_date) }}
                                    Nights
                                </td>
                    ...
                    <div class="flex justify-end">
                        <div class="w-64">
                            <div class="flex justify-between py-2 border-b border-gray-100">
                                ...
                                <span
                                    class="font-bold text-gray-800">${{ number_format($invoice->total_amount, 2) }}</span>
                            </div>
                            <div class="flex justify-between py-2 border-b border-gray-100">
                            ...
                            <div class="flex justify-between py-4">
                                ...
                                <span
                                    class="text-xl font-bold text-indigo-600">${{ number_format($invoice->total_amount, 2) }}</span>
                            </div>
                        </div>
                    </div>
