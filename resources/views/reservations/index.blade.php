                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-400 mt-1">
                                                {{ \Carbon\Carbon::parse($reservation->start_date)->diffInDays($reservation->end_date) ?? 0 }}
                                                night(s)
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if ($reservation->status != 'rejected')
                                                ...
                                                @elseif (!is_null($reservation->check_in) && is_null($reservation->check_out))
                                                    <div class="space-y-2">
                                                        <div class="text-xs text-gray-500 bg-gray-50 p-2 rounded">
                                                            Checked in:
                                                            {{ \Carbon\Carbon::parse($reservation->check_in)->format('M d, H:i') }}
                                                        </div>
                                                        <form method="POST"
                                                ...
                                                @elseif (!is_null($reservation->check_out))
                                                    <div class="text-center space-y-1">
                                                        ...
                                                        <div class="text-xs text-gray-500">
                                                            Out:
                                                            {{ \Carbon\Carbon::parse($reservation->check_out)->format('M d, H:i') }}
                                                        </div>
                                                    </div>
                                                @else
